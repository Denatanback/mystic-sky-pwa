            ...
            return (
              <div key={n.num} style={{ position: "absolute", left: `${n.x}%`, top: `${n.y}%`, transform: "translate(-50%, -50%)", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center" }}>
                <div style={{ position: "relative", width: 88, height: 88, display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <div style={{ width: nodeSize, height: nodeSize, borderRadius: "50%", overflow: "hidden", position: "relative", zIndex: 1, opacity: isLocked?0.78:1 }}>
                    <Image src={n.emblem} alt={n.label} fill style={{ objectFit: "contain", opacity: isLocked?0.55:1 }}/>
                  </div>
