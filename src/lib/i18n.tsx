...
const T = {
  ...
  ru: {
    ...
    register: {
      stepLabels: ["Аккаунт", "Рождение", "Интересы", "Старт"],
      step1Title: "Создай аккаунт",
      step1Sub: "Сохраним твой прогресс, карту и личные заметки.",
      nameLabel: "Имя",
      ...
      signIn: "Войти",
      step2Title: "Данные рождения",
      step2Sub: "Это основа для персональной карты и ежедневных подсказок.",
      birthDateLabel: "Дата рождения",
      birthDatePlaceholder: "ДД.ММ.ГГГГ",
      birthDateRequired: "Введите дату рождения",
      birthDateFull: "Введите полную дату в формате ДД.ММ.ГГГГ",
      birthDateFormat: "Формат: ДД.ММ.ГГГГ",
      birthMonthRange: "Месяц должен быть от 01 до 12",
      birthDayRange: "День должен быть от 01 до 31",
      birthYearRange: "Год должен быть от 1900 до",
      birthDateInvalid: "Такой даты не существует",
      birthTimeLabel: "Время рождения",
      birthTimePlaceholder: "ЧЧ:ММ",
      birthTimeFormat: "Введите время в формате ЧЧ:ММ",
      birthTimeFormatHint: "Формат: ЧЧ:ММ",
      birthHourRange: "Часы от 00 до 23",
      birthMinuteRange: "Минуты от 00 до 59",
      birthTimeUnknown: "Не знаю",
      birthTimeUnknownActive: "✓ Не знаю",
      birthTimeNote: "Необязательно. Уточняет асцендент и дома.",
      birthPlaceLabel: "Место рождения",
      birthPlacePlaceholder: "Москва, Россия",
      birthPlaceRequired: "Укажите место рождения",
      birthPlaceNote: "Начни с города. Страну можно добавить при необходимости.",
      step3Title: "Что тебе ближе?",
      step3Sub: "Выбери 1–2 направления. Это настроит твой первый путь.",
      directions: [
      ...
      step4Title: "Твой путь готов",
      step4Sub: "Мы собрали стартовую карту. Первый день начнётся с короткого прогноза и мягкой практики.",
      startMap: "Стартовая карта",
      startMapSub: "Создана по введённым данным",
      firstPath: "Первый путь",
      firstPathSub: "Интуиция и личный ритм",
      observationJournal: "Журнал наблюдений",
      observationJournalSub: "Готов для первых записей",
      enterEluna: "Перейти в Eluna →",
    },
    login: {
      title: "С возвращением",
      subtitle: "Твой путь продолжается с того места,\nгде ты остановился.",
      passwordLabel: "Пароль",
