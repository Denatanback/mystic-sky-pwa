...
export default function SpiritualPathPage() {
  ...
  const NODES: PathNode[] = false ? [
    { num: 1, label: "Spiritual Path",      sub: "Osnova",        desc: "The kind of spiritual practice your nature resonates with",                   status: "done",    emblem: "/assets/node-emblems/spiritual/emblem-1-meditation.png",     x: 50, y: 82 },
    ...
    { num: 1, label: "Spiritual Path",     sub: "Foundation",    desc: "The kind of spiritual practice your nature resonates with", status: "done",    emblem: "/assets/node-emblems/spiritual/emblem-1-meditation.png",     x: 50, y: 82 },
