...
export default function SoulmatePathPage() {
  ...
  const NODES: PathNode[] = false ? [
    { num: 1, label: "Soulmate Type",          sub: "Lyubov",        desc: "The kind of soulmate or person your energy may attract",        status: "done",    emblem: "/assets/node-emblems/soulmate/emblem-1-venus.png",    x: 50, y: 82 },
    ...
    { num: 1, label: "Soulmate Type",           sub: "Love",          desc: "The kind of soulmate or person your energy may attract",       status: "done",    emblem: "/assets/node-emblems/soulmate/emblem-1-venus.png",    x: 50, y: 82 },
