...
const MOON_ARCHETYPE: Record<string, { en: string; ru: string; desc: { en: string; ru: string } }> = {
  ...
  sagittarius: { en: "The Free Moon",      ru: "Luna Svobody",     desc: { en: "You process emotions through adventure, philosophy and humour. You need open skies.", ru: "Ty pererabatyvaesh emotsii cherez priklyucheniya, filosofiyu i yumor. Tebe nuzhno otkrytoe nebo." } },
