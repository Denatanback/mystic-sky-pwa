...
import { GlobalAccessGuard } from "@/components/subscription/GlobalAccessGuard";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${cormorant.variable} ${manrope.variable} ${lora.variable}`}>
      <body>
        <LanguageProvider><GuideProvider><AuthRouteGuard><GlobalAccessGuard><PrelandClaimGate>{children}</PrelandClaimGate></GlobalAccessGuard></AuthRouteGuard></GuideProvider></LanguageProvider>
      </body>
    </html>
  );
}
